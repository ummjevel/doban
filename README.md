...
도반(Doban)은 한국관광공사 OpenAPI를 활용해 지역별 관광 흐름, 관광 수요, 관광 자원 수요, 중심 관광지, 연관 관광지, 웰니스 관광정보를 분석하고 국내 예비창업자와 기존 소상공인에게 지역 창업 분석 결과를 제공하는 엔노이아 Studio 기반 챗봇이다.
